       ...
       setDescription (description) {
         ...
         handleThemeChange (newTheme) {
          ...
          event.preventDefault();
           ...
           axios.post('http://18.136.203.6:8000/blog/', data,      {
             headers: {
...
<h1 className="blog-testtt"> CREATE NEW BLOG </h1>
...
<p className="new1" > <InlineEdit
              ...
              text="Add a Title (Max Length: 200)"
              paramName="title"
...
<p className="new1" ><InlineEdit
              activeClassName="editing"
              text="Add a Description (Max Length: 200)"
    ...
    <div className="col-md-1">
      ...
      <div className="col-md-10 grid-item-new">
       ...
       <button className="join-new" type="button" onClick={this.onSubmit}>CREATE</button>
      </div>
